    ...
    >
      ...
      <ScrollView style={styles.body} contentContainerStyle={[styles.bodyContent, { paddingBottom: insets.bottom + 32 }]} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity style={[styles.submitBtn, { backgroundColor: '#06b6d4' }]} onPress={handleSubmit} disabled={loading}>
            {loading
        ...
        <TouchableOpacity style={styles.pickerOverlay} activeOpacity={1} onPress={() => setShowSupplierPicker(false)}>
          <View style={[styles.pickerSheet, { paddingBottom: insets.bottom + 16 }]}>
            <View style={styles.pickerHeaderRow}>
              ...
              <TouchableOpacity style={[styles.addInlineBtn, { backgroundColor: '#ecfeff', borderColor: '#a5f3fc' }]} onPress={() => { setShowSupplierPicker(false); setShowAddSupplier(true); }}>
                <Text style={[styles.addInlineTxt, { color: '#06b6d4' }]}>+ Add Supplier</Text>
              </TouchableOpacity>
            </View>
            <ScrollView showsVerticalScrollIndicator={false}>
              {suppliers.map(s => (
                <TouchableOpacity key={s.id} style={styles.pickerOption} onPress={() => { setPartyId(s.id); setShowSupplierPicker(false); }}>
                  <Text style={[styles.pickerOptionTxt, s.id === partyId && { color: '#06b6d4', fontWeight: '700' }]}>{s.name}</Text>
        ...
        <TouchableOpacity style={styles.pickerOverlay} activeOpacity={1} onPress={() => setShowTransporterPicker(false)}>
          <View style={[styles.pickerSheet, { paddingBottom: insets.bottom + 16 }]}>
            <View style={styles.pickerHeaderRow}>
              ...
              <TouchableOpacity style={[styles.addInlineBtn, { backgroundColor: '#ecfeff', borderColor: '#a5f3fc' }]} onPress={() => { setShowTransporterPicker(false); setShowAddTransporter(true); }}>
                <Text style={[styles.addInlineTxt, { color: '#06b6d4' }]}>+ Add Transporter</Text>
              </TouchableOpacity>
            </View>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              {transporters.map(t => (
                <TouchableOpacity key={t.id} style={styles.pickerOption} onPress={() => {
                  ...
                  <Text style={[styles.pickerOptionTxt, t.id === transporterId && { color: '#06b6d4', fontWeight: '700' }]}>{t.name}</Text>
...
const styles = StyleSheet.create({
  ...
  addItemBtn: { backgroundColor: '#ecfeff', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
  addItemTxt: { color: '#06b6d4', fontWeight: '700', fontSize: 13 },
  ...
  itemTotal: { fontSize: 14, fontWeight: '700', color: '#06b6d4' },
  ...
  totalsBox: { backgroundColor: '#ecfeff', borderRadius: 12, padding: 14, marginVertical: 10, borderWidth: 1, borderColor: '#a5f3fc' },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
  totalRowBig: { borderTopWidth: 1, borderTopColor: '#a5f3fc', marginTop: 4, paddingTop: 8 },
  ...
  grandVal: { fontSize: 15, fontWeight: '800', color: '#06b6d4' },
  ...
  checkboxActive: { borderColor: '#06b6d4', backgroundColor: '#06b6d4' },
  ...
  modeChipActive: { borderColor: '#06b6d4', backgroundColor: '#ecfeff' },
  modeChipTxt: { fontSize: 13, fontWeight: '600', color: '#6b7280' },
  modeChipTxtActive: { color: '#06b6d4' },
  ...
  addInlineBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: '#a5f3fc', backgroundColor: '#ecfeff' },
  addInlineTxt: { color: '#06b6d4', fontSize: 12, fontWeight: '700' },
});
